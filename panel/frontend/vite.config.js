...
export default defineConfig({
  ...
  test: {
    ...
    exclude: [
      'src/components/canonicalBackendDisplay.test.js',
      'src/components/l4/proxyEntryAuth.test.js',
      'src/components/relayLayerCompat.test.js',
      ...
      'src/components/base/BaseTabs.test.js',
      'src/components/certs/CertCard.test.js',
      'src/components/certs/CertTable.test.js',
      'src/components/common/AgentSearchSelect.test.js',
      'src/components/common/CreateAgentPicker.test.js',
      'src/components/common/ListPagination.test.js',
      'src/components/common/ResourceListFilterBar.test.js',
      'src/components/egress/EgressProfileForm.test.js',
      'src/components/l4/L4RuleItem.test.js',
      'src/components/operations/OperationStatus.test.js',
      'src/components/relay/RelayCard.test.js',
      'src/components/rules/RuleCard.test.js',
      'src/components/traffic/TrafficBreakdownTable.test.js',
      'src/components/traffic/TrafficHistoryManager.test.js',
      'src/components/traffic/TrafficPolicyForm.test.js',
      'src/components/traffic/TrafficQuotaRing.test.js',
      'src/components/traffic/TrafficRateSparkline.test.js',
      'src/components/traffic/TrafficSummaryCards.test.js',
