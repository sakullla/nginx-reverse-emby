...
export const fetchEgressProfiles = (...args) => call('fetchEgressProfiles', ...args)
export const createEgressProfile = (...args) => call('createEgressProfile', ...args)
export const updateEgressProfile = (...args) => call('updateEgressProfile', ...args)
export const deleteEgressProfile = (...args) => call('deleteEgressProfile', ...args)
export const fetchRules = (...args) => call('fetchRules', ...args)
export const fetchHttpRulesPage = (...args) => call('fetchHttpRulesPage', ...args)
...
export const fetchL4RulesPage = (...args) => call('fetchL4RulesPage', ...args)
...
export const fetchCertificatesPage = (...args) => call('fetchCertificatesPage', ...args)
...
export const fetchRelayListenersPage = (...args) => call('fetchRelayListenersPage', ...args)
...
export const fetchDashboardAttention = (...args) => call('fetchDashboardAttention', ...args)
export const fetchCloudflareDnsMappings = (...args) => call('fetchCloudflareDnsMappings', ...args)
export const fetchCloudflareDnsMapping = (...args) => call('fetchCloudflareDnsMapping', ...args)
export const createCloudflareDnsMapping = (...args) => call('createCloudflareDnsMapping', ...args)
export const renameCloudflareDnsMapping = (...args) => call('renameCloudflareDnsMapping', ...args)
export const rotateCloudflareDnsMapping = (...args) => call('rotateCloudflareDnsMapping', ...args)
export const deleteCloudflareDnsMapping = (...args) => call('deleteCloudflareDnsMapping', ...args)
