...
describe('runtime canonical rule payloads', () => {
  ...
  it('Egress profile UI is wired into routing, navigation, page, and rule forms', async () => {
    ...
    expect(router.default).toContain("path: 'egress-profiles'")
    expect(router.default).toContain("name: 'egress-profiles'")
    expect(sidebar.default).toContain('Egress Profiles')
    expect(sidebar.default).toContain('/egress-profiles')
    expect(bottomNav.default).toContain('/egress-profiles')
