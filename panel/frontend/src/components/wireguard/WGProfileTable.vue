    ...
    <table class="rules-table">
      ...
      <tbody>
        <tr v-for="profile in profiles" :key="profile.id" class="rules-table__row">
          ...
          <td class="rules-table__mono">{{ profile.name || `Profile ${profile.id}` }}</td>
          ...
          <td>
            <div class="rules-table__actions">
              <button class="btn-icon" title="编辑" @click="$emit('edit', profile)">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                </svg>
              </button>
              <button class="btn-icon btn-icon--danger" title="删除" @click="$emit('delete', profile)">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
