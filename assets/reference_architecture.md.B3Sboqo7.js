import{_ as a,o as n,c as e,a2 as p}from"./chunks/framework.CuEaBji2.js";const u=JSON.parse('{"title":"架构与设计","description":"","frontmatter":{},"headers":[],"relativePath":"reference/architecture.md","filePath":"reference/architecture.md","lastUpdated":1785415935000}'),l={name:"reference/architecture.md"};function i(t,s,r,c,o,b){return n(),e("div",null,[...s[0]||(s[0]=[p(`<h1 id="架构与设计" tabindex="-1">架构与设计 <a class="header-anchor" href="#架构与设计" aria-label="Permalink to &quot;架构与设计&quot;">​</a></h1><p>Nginx-Reverse-Emby 是一个纯 Go 实现的反向代理控制面，为 Emby、Jellyfin 以及任意 HTTP/TCP 服务设计。默认通过 Docker Compose 部署，内置一个 <code>local</code> Agent。</p><h2 id="组件关系" tabindex="-1">组件关系 <a class="header-anchor" href="#组件关系" aria-label="Permalink to &quot;组件关系&quot;">​</a></h2><div class="language-text vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>控制面</span></span>
...
<span class="line"><span>│  ├─ 规则、证书、Relay、出口配置存储</span></span>
...
<span class="line"><span>│  └─ 流量采集</span></span>
