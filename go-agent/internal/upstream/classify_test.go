...
func TestClassifyHTTPRequestCommonGETAsInteractive(t *testing.T) {
...
func TestClassifyHTTPRequestStreamingGETAsBulk(t *testing.T) {
	req := httptest.NewRequest("GET", "http://edge.example/Videos/1/stream", nil)
