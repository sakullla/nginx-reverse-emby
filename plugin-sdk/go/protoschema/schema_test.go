...
func TestPolicyV1DescriptorSurfaceIsStable(t *testing.T) {
	...
	assertMessages(t, file.Messages(), []messageExpectation{
		...
		{"EmitEventRequest", []fieldExpectation{{"code", 1, protoreflect.EnumKind, false, "nre.plugin.policy.v1.EmitEventRequest.Code"}, {"action", 2, protoreflect.EnumKind, false, "nre.plugin.policy.v1.EmitEventRequest.Action"}, {"rule_index", 3, protoreflect.Uint32Kind, false, ""}, {"dataset_index", 4, protoreflect.Uint32Kind, false, ""}, {"classification_index", 5, protoreflect.Uint32Kind, false, ""}, {"outbound_index", 6, protoreflect.Uint32Kind, false, ""}, {"reason", 7, protoreflect.EnumKind, false, "nre.plugin.policy.v1.EmitEventRequest.Reason"}, {"domain_source", 8, protoreflect.EnumKind, false, "nre.plugin.policy.v1.EmitEventRequest.DomainSource"}}},
		...
		{"ReadTrustedSourceRequest", []fieldExpectation{}},
		{"TrustedSource", []fieldExpectation{{"instance_id", 1, protoreflect.StringKind, false, ""}, {"generation", 2, protoreflect.StringKind, false, ""}, {"entry_id", 3, protoreflect.StringKind, false, ""}, {"peer_address", 4, protoreflect.BytesKind, false, ""}, {"source_address", 5, protoreflect.BytesKind, false, ""}, {"authority", 6, protoreflect.EnumKind, false, "nre.plugin.policy.v1.TrustedSource.Authority"}}},
		{"TrustedSourceResponse", []fieldExpectation{{"source", 1, protoreflect.MessageKind, false, "nre.plugin.policy.v1.TrustedSource"}, {"error", 2, protoreflect.MessageKind, false, "nre.plugin.policy.v1.RuntimeError"}}},
		{"DatasetReference", []fieldExpectation{{"handle", 1, protoreflect.StringKind, false, ""}, {"instance_id", 2, protoreflect.StringKind, false, ""}, {"generation", 3, protoreflect.StringKind, false, ""}, {"source_id", 4, protoreflect.StringKind, false, ""}, {"version_digest", 5, protoreflect.StringKind, false, ""}}},
		{"DatasetResolveRequest", []fieldExpectation{{"source_id", 1, protoreflect.StringKind, false, ""}, {"max_duration_micros", 2, protoreflect.Uint32Kind, false, ""}, {"max_response_bytes", 3, protoreflect.Uint32Kind, false, ""}}},
		{"DatasetResolveResponse", []fieldExpectation{{"reference", 1, protoreflect.MessageKind, false, "nre.plugin.policy.v1.DatasetReference"}, {"error", 2, protoreflect.MessageKind, false, "nre.plugin.policy.v1.RuntimeError"}}},
		{"DatasetClassification", []fieldExpectation{{"name", 1, protoreflect.StringKind, false, ""}, {"kind", 2, protoreflect.EnumKind, false, "nre.plugin.policy.v1.DatasetClassification.Kind"}}},
		{"DatasetQueryRequest", []fieldExpectation{{"reference", 1, protoreflect.MessageKind, false, "nre.plugin.policy.v1.DatasetReference"}, {"classifications", 2, protoreflect.MessageKind, true, "nre.plugin.policy.v1.DatasetClassification"}, {"max_duration_micros", 3, protoreflect.Uint32Kind, false, ""}, {"max_response_bytes", 4, protoreflect.Uint32Kind, false, ""}}},
		{"DatasetMatch", []fieldExpectation{{"index", 1, protoreflect.Uint32Kind, false, ""}, {"matched", 2, protoreflect.BoolKind, false, ""}, {"coverage", 3, protoreflect.EnumKind, false, "nre.plugin.policy.v1.DatasetMatch.Coverage"}}},
		{"DatasetQueryResponse", []fieldExpectation{{"reference", 1, protoreflect.MessageKind, false, "nre.plugin.policy.v1.DatasetReference"}, {"status", 2, protoreflect.EnumKind, false, "nre.plugin.policy.v1.DatasetQueryResponse.Status"}, {"matches", 3, protoreflect.MessageKind, true, "nre.plugin.policy.v1.DatasetMatch"}}},
	})
	...
	assertEnum(t, emitEvent.Enums().ByName("Code"), []enumValueExpectation{{"SECURITY_EVENT_CODE_UNSPECIFIED", 0}, {"SECURITY_EVENT_CODE_WAF_RULE_MATCH", 1}, {"SECURITY_EVENT_CODE_IP_RULE_MATCH", 2}, {"SECURITY_EVENT_CODE_IP_CHECK_FAILURE", 3}, {"SECURITY_EVENT_CODE_ROUTING_RULE_MATCH", 4}, {"SECURITY_EVENT_CODE_ROUTING_FAILURE", 5}})
	assertEnum(t, emitEvent.Enums().ByName("Action"), []enumValueExpectation{{"SECURITY_EVENT_ACTION_UNSPECIFIED", 0}, {"SECURITY_EVENT_ACTION_OBSERVE", 1}, {"SECURITY_EVENT_ACTION_DENY", 2}, {"SECURITY_EVENT_ACTION_ALLOW", 3}, {"SECURITY_EVENT_ACTION_DIRECT", 4}, {"SECURITY_EVENT_ACTION_UPSTREAM", 5}})
	assertEnum(t, emitEvent.Enums().ByName("Reason"), []enumValueExpectation{{"SECURITY_EVENT_REASON_NONE", 0}, {"SECURITY_EVENT_REASON_SOURCE_UNAUTHENTICATED", 1}, {"SECURITY_EVENT_REASON_DATASET_UNAVAILABLE", 2}, {"SECURITY_EVENT_REASON_CLASSIFICATION_MISSING", 3}, {"SECURITY_EVENT_REASON_BUDGET_EXCEEDED", 4}, {"SECURITY_EVENT_REASON_UPSTREAM_UNAVAILABLE", 5}, {"SECURITY_EVENT_REASON_UPSTREAM_AUTHENTICATION", 6}, {"SECURITY_EVENT_REASON_PROTOCOL_UNSUPPORTED", 7}, {"SECURITY_EVENT_REASON_DATA_INVALID", 8}, {"SECURITY_EVENT_REASON_COVERAGE_UNKNOWN", 9}, {"SECURITY_EVENT_REASON_REVOKED", 10}})
	assertEnum(t, emitEvent.Enums().ByName("DomainSource"), []enumValueExpectation{{"SECURITY_EVENT_DOMAIN_SOURCE_UNSPECIFIED", 0}, {"SECURITY_EVENT_DOMAIN_SOURCE_ORIGINAL", 1}, {"SECURITY_EVENT_DOMAIN_SOURCE_HTTP_HOST", 2}, {"SECURITY_EVENT_DOMAIN_SOURCE_TLS_SNI", 3}, {"SECURITY_EVENT_DOMAIN_SOURCE_IP_ONLY", 4}, {"SECURITY_EVENT_DOMAIN_SOURCE_UNAVAILABLE", 5}})
	assertExclusiveResult(t, file.Messages().ByName("TrustedSourceResponse"), 2, nil)
	assertExclusiveResult(t, file.Messages().ByName("DatasetResolveResponse"), 2, nil)
	assertEnum(t, file.Messages().ByName("TrustedSource").Enums().ByName("Authority"), []enumValueExpectation{{"AUTHORITY_UNSPECIFIED", 0}, {"AUTHORITY_SOCKET", 1}, {"AUTHORITY_XFF", 2}, {"AUTHORITY_PROXY", 3}, {"AUTHORITY_RELAY", 4}})
	assertEnum(t, file.Messages().ByName("DatasetClassification").Enums().ByName("Kind"), []enumValueExpectation{{"KIND_UNSPECIFIED", 0}, {"KIND_COUNTRY", 1}, {"KIND_REGION", 2}, {"KIND_CIDR", 3}})
	assertEnum(t, file.Messages().ByName("DatasetMatch").Enums().ByName("Coverage"), []enumValueExpectation{{"COVERAGE_UNSPECIFIED", 0}, {"COVERAGE_COVERED", 1}, {"COVERAGE_UNKNOWN", 2}, {"COVERAGE_UNSUPPORTED_FAMILY", 3}})
	assertEnum(t, file.Messages().ByName("DatasetQueryResponse").Enums().ByName("Status"), []enumValueExpectation{{"STATUS_UNSPECIFIED", 0}, {"STATUS_OK", 1}, {"STATUS_UNAVAILABLE", 2}, {"STATUS_MISSING_CLASSIFICATION", 3}, {"STATUS_BUDGET_EXCEEDED", 4}, {"STATUS_UNAUTHORIZED", 5}, {"STATUS_STALE_REFERENCE", 6}, {"STATUS_INVALID_DATA", 7}})
}
